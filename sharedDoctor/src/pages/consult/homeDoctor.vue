          ...
          <van-tab
            ...
            <div>
              ...
              <div>
                ...
                >
                  <div @click="nextStep(homeTimeSlot,dateIndex-1,index)">
                    <van-col span="24">
                    <span>
                      {{homeTimeSlot}}
                    </span>
...
<script>
  ...
  export default {
    ...
    methods: {
          ...
          if (isOk) {
            ...
            for (let i = 0; i < tempTimeTable.length; i++) {
              ...
              if (tableStartTime.getTime() >= new Date().getTime() && ((tableStartTime.getTime() - new Date().getTime()) / (24 * 60 * 60 * 1000)) <= 7 && tempTimeTable[i].isOrdered == 0) {
                ...
                // this.homeTimeSlotTable[(tableStartTime.getTime()-new Date().getTime())/(24 * 60 * 60 * 1000)].push((tableStartTime.getHours()+ ':00 —— ' + (tableStartTime.getHours()+1) + ':00'))
      ...
      nextStep(homeTimeSlot,dateIndex,index) {
        if (LOCWIN.Cache.get('userInfo') == null) {
          ...
          LOCWIN.Cache.set('reserveDate', this.currentDate + '号,周' + this.weekday[this.activeHomeTime] + ',' + homeTimeSlot)
          console.log(LOCWIN.Cache.get('reserveDate'))
          this.$router.push('/illnessDetailHome')
        }
      },
    },
  };
